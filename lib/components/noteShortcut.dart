...
class NoteShortcutBar extends StatefulWidget {
  final TextEditingController controller;

  const NoteShortcutBar({required this.controller, super.key});

  @override
  State<NoteShortcutBar> createState() => _NoteShortcutBarState();
}

class _NoteShortcutBarState extends State<NoteShortcutBar> {
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...
              // Additional plain text shortcuts can be added here if desired
            ],
          ),
        ),
      ),
